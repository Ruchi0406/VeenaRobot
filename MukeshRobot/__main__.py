...
def get_readable_time(seconds: int) -> str:
    ...
    return ping_time
PM_START_TEX = """
ʜᴇʟʟᴏ `{}`, \nτнαиκѕ ϐγ τнє ѕι∂є οƒ νєєиα αи∂ α∂ιτγα\nʜᴏᴡ ᴀʀᴇ . . . 
"""
...
buttons = [
    [
        ...
        InlineKeyboardButton(text="🪄", url=f"https://t.me/JeeStudyRoom"),
     ],
    [
...
ʏᴏᴜ ᴄᴀɴ ᴅɪʀᴇᴄᴛʟʏ ᴄᴏɴᴛᴀᴄᴛ ᴍʏ ᴅᴇᴠᴇʟᴏᴘᴇʀ @jsruordinators ғᴏʀ ᴅᴏɴᴀᴛɪɴɢ ᴏʀ ʏᴏᴜ ᴄᴀɴ ᴠɪsɪᴛ ᴍʏ sᴜᴩᴩᴏʀᴛ ᴄʜᴀᴛ @offtopic_community ᴀɴᴅ ᴀsᴋ ᴛʜᴇʀᴇ ᴀʙᴏᴜᴛ ᴅᴏɴᴀᴛɪᴏɴ."""
...
def start(update: Update, context: CallbackContext):
    ...
    if update.effective_chat.type == "private":
        if len(args) >= 1:
            ...
            lol.edit_text("⚡")
            time.sleep(0.3)
            lol.edit_text("ꜱᴛᴀʀᴛɪɴɢ... 𝐕ᴇᴇɴᴀ 𝐎ᴘ")
            time.sleep(0.4)
            lol.delete()
...
"*🧣𝗔𝐛𝐨𝐮𝘁: 𝚄𝚜𝚎 𝚝𝚑𝚎 /𝐠𝐩𝐭 𝚌𝚘𝚖𝚖𝚊𝚗𝚍 𝚝𝚘 𝚒𝚗𝚝𝚎𝚛𝚊𝚌𝚝 𝚠𝚒𝚝𝚑 𝚝𝚑𝚎 𝚊𝚍𝚟𝚊𝚗𝚌𝚎𝚍 𝐂𝐇𝐀𝐓 𝐆𝐏𝐓-𝟒 𝚖𝚘𝚍𝚎𝚕 𝚏𝚘𝚛 𝚊𝚗 𝚎𝚗𝚑𝚊𝚗𝚌𝚎𝚍 𝚌𝚑𝚊𝚝 𝚎𝚡𝚙𝚎𝚛𝚒𝚎𝚗𝚌𝚎. 𝚃𝚑𝚒𝚜 𝚒𝚜 𝚊 𝚗𝚎𝚠 𝚏𝚎𝚊𝚝𝚞𝚛𝚎, 𝚊𝚗𝚍 𝚢𝚘𝚞 𝚌𝚊𝚗 𝚞𝚜𝚎 𝚒𝚝 𝚞𝚗𝚕𝚒𝚖𝚒𝚝𝚎𝚍𝚕𝚢.*\n\n"

"*🧩 𝗙𝐞𝐚𝐭𝐮𝐫𝐞𝘀:- /𝐠𝐩𝐭 [𝐲𝐨𝐮𝐫 𝐦𝐞𝐬𝐬𝐚𝐠𝐞]:*\n"
"*𝙸𝚗𝚒𝚝𝚒𝚊𝚝𝚎 𝚊 𝚌𝚘𝚗𝚟𝚎𝚛𝚜𝚊𝚝𝚒𝚘𝚗 𝚠𝚒𝚝𝚑 𝐂𝐇𝐀𝐓 𝐆𝐏𝐓-𝟒, 𝚊𝚗𝚍 𝚒𝚝 𝚠𝚒𝚕𝚕 𝚙𝚛𝚘𝚟𝚒𝚍𝚎 𝚝𝚑𝚘𝚞𝚐𝚑𝚝𝚏𝚞𝚕 𝚊𝚗𝚍 𝚌𝚘𝚗𝚝𝚎𝚡𝚝𝚊𝚠𝚊𝚛𝚎 𝚛𝚎𝚜𝚙𝚘𝚗𝚜𝚎𝚜.*\n\n"
    ...
    if query.data == "mukesh_":
        ...
        InlineKeyboardButton(text="🖥️", callback_data="Main_help"),
                    ...
                    [
                        ...
                        InlineKeyboardButton(
                            text="ᴜᴩᴅᴀᴛᴇs 🍷", url=f"https://t.me/jee_study_room"
                        ),
                    ],
                    [
                        InlineKeyboardButton(
                        ...
                        InlineKeyboardButton(
                            text="ɢɪᴛʜᴜʙ 🍹", url="https://te.legra.ph/file/2e1ae025e30642b4efe9c.jpg"
                        ),
                    ],
                    [
                        InlineKeyboardButton(text="◁", callback_data="mukesh_"),
...
*ʜᴇʀᴇ ɪs ᴍʏ sᴏᴜʀᴄᴇ ᴄᴏᴅᴇ :* [ɢɪᴛʜᴜʙ](https://te.legra.ph/file/2e1ae025e30642b4efe9c.jpg)


{BOT_NAME} ɪs ʟɪᴄᴇɴsᴇᴅ ᴜɴᴅᴇʀ ᴛʜᴇ [ᴍɪᴛ ʟɪᴄᴇɴsᴇ](https://t.me/uttarpradeshi_17).
...
""",
            ...
            reply_markup=InlineKeyboardMarkup(
                [[
        InlineKeyboardButton(text="sᴏᴜʀᴄᴇ", url="https://te.legra.ph/file/2e1ae025e30642b4efe9c.jpg")
                ],
                 [
        InlineKeyboardButton(text="🏡", callback_data="mukesh_back"),
        InlineKeyboardButton(text="🪻", callback_data="mukesh_"),
...
━━━━━━━━━━━━━
**ᴍᴀᴅᴇ ᴡɪᴛʜ ❤️ ʙʏ [Aᴅɪᴛʏᴀ](https://t.me/jsruordinators)**
**ᴘʏᴛʜᴏɴ ᴠᴇʀsɪᴏɴ:** `{y()}`
